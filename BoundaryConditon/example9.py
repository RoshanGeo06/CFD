...
if __name__ == "__main__":
    ...
    # underground
    # hull optamization
    # weight of model, density of water (>1.03), current speed, speed of vessel to be travel
    # speed variation from 4 to 10- calculate the resistance
    # static model and changing speed of current
    # moving the model seperatly and current on different directions
